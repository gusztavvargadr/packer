images = {
  ...
  "insider-preview-standard" = {
    ...
    native = {
      ...
      source_iso_url_remote = "https://app.vagrantup.com/gusztavvargadr-iso/boxes/windows-server-insider-preview/versions/2302.0.2312/providers/iso/amd64/vagrant.box"
