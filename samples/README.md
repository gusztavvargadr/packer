...
This folder contains [Packer] samples for creating Windows and Ubuntu images in various development scenarios.
...
[Windows Server README](./windows-server/README.md)  
[Windows Server folder](./windows-server)  
...
1. Install the tools for the virtualization provider you want to use.
    ...
    - **VMware** Install [VMware Workstation Pro][VMwareWorkstationProInstallation].
...
[VagrantGettingStarted]: https://developer.hashicorp.com/vagrant/tutorials
...
[VMwareWorkstationProInstallation]: https://www.vmware.com/products/workstation-pro/workstation-pro-evaluation.html
