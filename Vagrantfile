...
VagrantDeployment.configure(directory, 'stack' => 'packer') do |deployment|
  ...
  create_machine(deployment, 'u16s')

  create_machine(deployment, 'u16d')
  ...
  create_machine(deployment, 'u16s-dc')
  create_machine(deployment, 'u16d-dc')
  ...
  create_machine(deployment, 'w10e-dc-vs17c')
