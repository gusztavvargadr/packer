...
action :install do
  directory_path = "#{Chef::Config[:file_cache_path]}/gusztavvargadr_packer_vs/2015_#{edition}"
  ...
  installer_file_source = node['gusztavvargadr_packer_vs']["2015_#{edition}"]['installer_file_url']
